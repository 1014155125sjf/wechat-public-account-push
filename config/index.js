export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxca636e9381b72d9a",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "7ce98f2f7df590a170a6e0855a50b750",
  ...
  USERS: [
    {
      ...
      id: "opKAL6wHeYDt0JmvN4dK8RdJr8YQ",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "jg4pEVJYU76rG4Su87QdOt94iUtig2CbwG8K69xBqdM",
      // 所在省份
      province: "海南",
      // 所在城市
      city: "海口",
